...
namespace LCU.State.API.NapkinIDE.NapkinIDE.LimitedTrial
{
    ...
    public class SetActiveApp
    {
        ...
        {
            return await stateBlob.WithStateHarness<LimitedDataAppsManagementState, SetActiveAppRequest, LimitedDataAppsStateHarness>(req, signalRMessages, log,
                async (harness, reqData, actReq) =>
            {
                ...
                await harness.SetActiveApp(stateDetails.EnterpriseAPIKey, reqData.App);
